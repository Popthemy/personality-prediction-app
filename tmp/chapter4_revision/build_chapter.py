...
OUT=ROOT.parents[1]/'output/documents/rewritten_chapter_four.docx'
...
def paragraph(text,kind='body'):
    ...
    if kind=='title':
        ...
        el=OxmlElement('w:outlineLvl');el.set(qn('w:val'),'1' if re.match(r'4\.\d+\.\d+',text) else '0');p._p.pPr.append(el)
...
doc.core_properties.subject='Personality prediction: recorded findings and evidence insertion areas'
